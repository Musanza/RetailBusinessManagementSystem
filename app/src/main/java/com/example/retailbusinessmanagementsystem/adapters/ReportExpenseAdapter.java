...
public class ReportExpenseAdapter extends RecyclerView.Adapter<ReportExpenseAdapter.ProductViewHolder>{
    private List<Cash> listCash;
    public ReportExpenseAdapter(List<Cash> listCash) {
    ...
    @NotNull
    @Override
    public ReportExpenseAdapter.ProductViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull ReportExpenseAdapter.ProductViewHolder holder, int position) {
